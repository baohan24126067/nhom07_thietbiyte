...
export function ProductCard({
  ...
  return (
    <article className="rounded-[28px] border border-[var(--color-line)] bg-white p-5 shadow-[0_20px_60px_rgba(17,57,95,0.08)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_24px_70px_rgba(17,57,95,0.12)] motion-safe">
      <Link
        href={`/products/${product.slug}`}
        className="flex aspect-[1/0.82] items-center justify-center rounded-[24px] bg-[linear-gradient(180deg,#fefefe,#edf5fc)] p-5"
      >
        <ProductIllustration
          product={product}

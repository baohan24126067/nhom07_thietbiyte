...
export function ProductCard({
  ...
  return (
    <article className="rounded-[6px] border border-[var(--color-line)] bg-white p-4 shadow-[0_1px_0_rgba(255,255,255,0.65)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(17,57,95,0.10)] motion-safe">
      <div className="flex aspect-[1/0.82] items-center justify-center rounded-[4px] bg-[linear-gradient(180deg,#fefefe,#edf5fc)] p-5">
        <ProductIllustration
          product={product}
      ...
      <h3 className="mt-2 block min-h-14 text-[18px] font-bold text-[var(--color-ink)]">
        {product.name}
      </h3>
